...
class Query
{
    ...
    /** Determines whether to convert types when fetching rows from Select */
    public bool $convertRead = false;
    /** Determines whether to convert types within Base::buildParameters() */
     ...
     *
     * @param null|string $table db table name
